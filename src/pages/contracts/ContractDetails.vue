                ...
                <v-radio-group v-model="details.status">
                  <div class="d-flex align-center justify-space-between" :class="details.status == 'pending' ? 'blue-1'
                    ...
                    <span class="mr-5" :class="details.status == 'pending' ? 'blue-1'
                      : details.status == 'completed' ? '#3CB22B' : 'success'">{{ details.status == 'pending' ?
                        'Pending' :
                        details.status == 'reject' ?
                          'Rejected' : 'In Progress' }}</span>
            ...
            <VCol cols="12" v-if="details.status != 'reject'">
              <v-card>
                ...
                <div class="d-flex align-center justify-center">
                  ...
                  <v-btn class="mr-5" @click="uploadFiles" elevation="24" size="large">UPLOAD NEW FILE</v-btn>
                </div>
                <v-card-item>
                  <v-row no-gutters>
